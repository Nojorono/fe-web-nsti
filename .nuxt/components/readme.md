...
- `<ProductsCarousel>` | `<products-carousel>` (components/ProductsCarousel.vue)
- `<ProductsCarouselMobile>` | `<products-carousel-mobile>` (components/ProductsCarouselMobile.vue)
...
- `<CmsEmptyCard>` | `<cms-empty-card>` (components/cms/EmptyCard.vue)
- `<CmsFormAdd>` | `<cms-form-add>` (components/cms/formAdd.vue)
