      ...
      <div class="nav-list">
        ...
        >
          ...
          <div class="dropdown-menu-hover-content">
            ...
            >
              <span @click="funcScrollTo('#about-us-milestone', '/id/about-us')"
              >{{$t('navbar.about.milestone')}}</span
              >
              <span @click="funcScrollTo('#about-us-visi-misi', '/id/about-us')"
              >{{$t('navbar.about.vision')}}</span
              >
              <span @click="funcScrollTo('#about-us-values', '/id/about-us')"
              >{{$t('navbar.about.core')}}</span
              >
              <span @click="funcScrollTo('#about-us-management', '/id/about-us')"
        ...
        >
          ...
          <div class="dropdown-menu-hover-content">
            ...
            >
              <span @click="funcScrollTo('#export-quality-tobacco', '/id/export')"
