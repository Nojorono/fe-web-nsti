export default {
  ...
  home: {
    ...
    lifeAt: {
      ...
      subTitle:
        'We open opportunities for experienced workers to join us according to their knowledge, abilities, and experience.',
    },
    contact: {
  ...
  aboutUs: {
    title: 'OVERVIEW',
    subText1:
      'PT Nikki Super Tobacco Indonesia was established on November 11, 1990 and is a cigarette manufacturer from Kudus, known as the city of kretek. PT Nikki Super Tobacco Indonesia is one of the leading cigarette manufacturers in Central Java with a national market reach.',
    subText2:
